...
function getQRImage(){
    return '<img src="https://qrtag.net/api/qr_transparent_12.svg?url=' + window.location.href + '"" alt="qrCode">';
}
...
function copySharingLink(courseName){
    return navigator.clipboard.writeText("Start studying " + courseName + " now at: " + window.location.href)
}